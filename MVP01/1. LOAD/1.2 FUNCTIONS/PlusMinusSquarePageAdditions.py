...
page_arrow_statements = [{"pagenr": 1,
        "top":
...
page_tendency_statements = [{"pagenr": 1,
    "one":
        {"times": "",
        "squares": [],
        "replaced by": []},
    ...
    {"pagenr": 5,
        ...
        "two":
            ...
            "squares": [1,3,6,10,15,21,28,34,39,44,48,51,52], # all squares with tendency (increase, 1) value
            "replaced by": [7]},
        "three":
            {}},
    ...
    {"pagenr": 6,
        ...
        "two":
            {"times": 1,
            "squares": [2,11,19,23,29,33,38,40,44,46,50,52], # all squares with (decrease, 4) ONLY VALID WHEN 4/4 HAS BEEN CHOSEN
            "replaced by": [12]},
        "three":
            {"times": 1,
